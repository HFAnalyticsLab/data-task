...
Please email your answers to @health.org.uk by Friday 6 January 2023. 
...
- 2.1) Can you describe the trends you are seeing in the response times data?
- 2.2) Can you briefly describe what the implications for patients and the health system are?
- 2.3) What is the benefit of looking at the 90th percentile and not just the mean?
- 2.4) How would you visualize this differently to better show the spread between the mean and 90th percentiles?
...
- 3.1) How would you represent these time trends differently to make comparisons easier between the four medical specialties?
- 3.2) What approach would you take to summarise the change in the size of the total waiting list for each specialty between 2020 and 2021?
- 3.3) Based on what you are seeing here, why do you think the size of the total waiting list is increasing?
